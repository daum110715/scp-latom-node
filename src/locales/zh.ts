...
> 文档保密等级：**绝密**`,
  ...
  about: {
    ...
    security: {
      ...
      item1Title: '权限等级',
      item1Desc: '人员被分配从0级（一般）到5级（O5指挥部）的权限等级。每个级别授予对逐步敏感信息的访问权限。4级人员（如运营本节点的人员）可以访问大多数SCP文档和运营数据。',
      item2Title: '文档分类',
      item2Desc: '所有基金会文档被分类为非受限、受限、机密、绝密或最高绝密。分类级别决定谁可以访问、复制或分发文档。未授权的访问尝试会被自动记录并报告给内部安全局。',
      item3Title: '记忆删除协议',
      item3Desc: '在信息泄露或平民接触事件中，基金会部署针对性的记忆删除处理以维护运营安全。A级记忆删除剂擦除特定记忆；B级记忆删除剂引起普遍混淆；C级记忆删除剂导致暂时性定向障碍。',
    },
    structure: {
      title: '基金会架构',
      desc: '基金会通过分层组织架构运作，旨在实现最大运营效率和信息隔离。',
      item1Title: 'O5议会',
      item1Desc: '监督者议会由十三名拥有基金会最高权力的个人组成。他们拥有完全自主权，不向任何政府或组织负责。他们的身份甚至对大多数基金会人员也是保密的。',
      item2Title: '伦理委员会',
      item2Desc: '负责监督基金会运营道德行为的独立机构。委员会有权否决被认为不必要地残忍或对人员构成危险的收容程序。',
      item3Title: '机动特遣队',
      item3Desc: '专门处理特定类型异常威胁的特遣队。每个MTF由具有相关专业知识的人员组成，从战斗人员到外勤研究人员。全球有超过100个活跃MTF在运作。',
      item4Title: '站点主管',
      item4Desc: '每个基金会设施由一名站点主管管理，对指定地点拥有完全运营权限。站点主管直接向O5议会报告，负责收容、研究和人员管理。',
    },
    system: {
      title: '系统信息',
      terminal: '终端',
    ...
    footer: {
      disclaimer: 'SCP基金会是scpwiki.com协作写作项目中的虚构组织。本文档系统是由爱好者创建的主题界面。所有SCP内容均依据CC BY-SA 3.0许可协议发布。',
    },
  },
  notFound: {
    accessDenied: '访问被拒绝',
