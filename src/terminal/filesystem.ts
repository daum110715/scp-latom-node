/**
 * Virtual filesystem for the SCP Foundation terminal.
 * Provides a tree of directories and files with SCP-themed content.
 */
...
interact with SCP-131 instances during designated hours. Both instances must
be kept together at all times.
